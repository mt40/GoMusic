...
{
    public partial class MainPageDark_List : PhoneApplicationPage
    {
        ...
        private void InitData(GoMusic.MyControls.SplashScreenControl spl = null)
        {
            ...
            //if (GeneralService.Instance.IsListViewUsed)
            //{
            //    StackVirtualizationStrategyDefinition tmp = new StackVirtualizationStrategyDefinition();
            //    rad_GridArtist.VirtualizationStrategyDefinition = tmp;
            //    rad_GridAlbum.VirtualizationStrategyDefinition = tmp;

            //    //rad_GridArtist.GroupHeaderTemplate = Resources["GroupHeaderTemplate_List"] as DataTemplate;
            //    //rad_GridAlbum.GroupHeaderTemplate = Resources["GroupHeaderTemplate_List"] as DataTemplate;

            //    rad_GridArtist.IsStickyHeaderEnabled = true;
            //    rad_GridAlbum.IsStickyHeaderEnabled = true;
            ...
            //rad_GridAlbum.ItemTemplate = Resources["AlbumItemTemplate2"] as DataTemplate;

            //Thickness tn = new Thickness(10, 15, 0, 10);
            //rad_GridArtist.Margin = rad_GridAlbum.Margin = tn;
            //}

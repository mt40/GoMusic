...
namespace GoMusic.Views.LightTheme
{
    public partial class SettingPage : PhoneApplicationPage
    {
        ...
        private void SwitchTheme_Switched(object sender, EventArgs e)
        {

        }

        private void GridLyricsSetting_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
        ...
        {
            NavigationService.Navigate(new Uri("/Views/LightTheme/ThemeSelectionPage.xaml", UriKind.RelativeOrAbsolute));
        }
    }
}